...
Public Class Null
    ...
    Public Shared Function SetNullLong(ByVal objValue As Object) As Long
        Dim retValue As Long = Null.NullInteger
        If Not IsDBNull(objValue) Then
    ...
    Public Shared Function SetNullGuid(ByVal objValue As Object) As Guid
        Dim retValue As Guid = Null.NullGuid
        If Not IsDBNull(objValue) Then
    ...
    Public Shared Function SetNullDecimal(ByVal objValue As Object) As Single
        Dim retValue As Decimal = Null.NullDecimal
        If Not IsDBNull(objValue) Then
