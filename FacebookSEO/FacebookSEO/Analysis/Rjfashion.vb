...
Public Class Rjfashion
    ...
    Public Shared Sub Start(ByVal IssueID As Integer, ByVal siteId As Integer, ByVal planType As String, _
        ...
        If planType = "HD" Then
            InsertCategory(siteId, IssueID, url)
            InsertProductData(siteId, IssueID, url)
            GetSubject(IssueID)
            helper.InsertContactList(IssueID, "Taobao_13_4_5", "waiting") 'draft
            helper.InsertContactList(IssueID, "Reasonablers", "waiting")
            helper.InsertContactList(IssueID, "Inboxtest", "waiting")
            helper.InsertContactList(IssueID, "Herbert", "waiting")
            helper.InsertContactList(IssueID, "RmojulSubscribers", "waiting")
        Else
            RjNews.Start(IssueID, siteId, planType, splitContactCount, spreadLogin, appId, url, preSubject)
        End If
    ...
    Public Shared Sub InsertProductData(ByVal siteId As Integer, ByVal IssueId As Integer, ByVal ShopUrl As String)
        Dim hotSellUrl As String = "http://rjfashion.taobao.com/search.htm?scid=761317549&orderType=_coefp" 'ShopUrl + "/search.htm?orderType=_hotsell"
        Dim newOnUrl As String = "http://rjfashion.taobao.com/search.htm?scid=760277021&orderType=_coefp" ' ShopUrl + "/search.htm?orderType=newon"
        Dim hotKeepUrl As String = "http://rjfashion.taobao.com/search.htm?scid=759197092&orderType=_coefp" ' ShopUrl + "/search.htm?orderType=_hotkeep"
