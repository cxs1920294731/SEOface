...
Public Class DressLilyMen
    ...
    Public Sub Start(ByVal issueId As Integer, ByVal siteId As Integer, ByVal planType As String, _
        ...
        Try
            ...
            Try
                '获取Men's Clothing的产品，并使用2个产品作为Promotion
                Dim menClothingUrl As String = "http://www.dresslily.com/men-s-clothing-b-2.html?odr=new"
                'Delete by Dora 2013-12-02 因为找不到Men's Shoes这个链接，获取不到这一块的信息，只好去掉
                'GetProductAndProductIssue(menClothingUrl, 8, "Men's Clothing", siteId, issueId, nowTime)
            ...
            Try
                '获取Men's Shoes的产品
                Dim menShoesUrl As String = "http://www.dresslily.com/men-s-shoes-c-82.html"
                'Delete by Dora 2013-11-26 因为找不到Men's Shoes这个链接，获取不到这一块的信息，只好去掉
                'GetProductAndProductIssue(menShoesUrl, 8, "Men's Shoes", siteId, issueId, nowTime)
            Catch ex As Exception
                '2013/07/19 added,throw the exception to outer layer
                Throw New Exception(ex.ToString())
                'Ignore
            ...
            Try
                '获取Men's Bags的产品
                Dim menBagsUrl As String = "http://www.dresslily.com/men-s-bags-c-127.html?odr=new"
                'Delete by Dora 2013-12-02 因为找不到Men's Shoes这个链接，获取不到这一块的信息，只好去掉
                'GetProductAndProductIssue(menBagsUrl, 8, "Men's Bags", siteId, issueId, nowTime)
            Catch ex As Exception
                '2013/07/19 added,throw the exception to outer layer
                Throw New Exception(ex.ToString())
                'Ignore
            ...
            Try
                '获取Men's Watches的产品
                Dim menWatchUrl As String = "http://www.dresslily.com/men-s-watches-c-125.html?odr=new"
                GetProductAndProductIssue(menWatchUrl, 8, "Men's Watches", siteId, issueId, nowTime)
            Catch ex As Exception
                '2013/07/19 added,throw the exception to outer layer
                Throw New Exception(ex.ToString())
                'Ignore
            ...
            Try
                '获取Women's Clothing的产品
                Dim womenClothingUrl As String = "http://www.dresslily.com/women-s-clothing-b-1.html?odr=new"
                GetProductAndProductIssue(womenClothingUrl, 8, "Women's Clothing", siteId, issueId, nowTime)
            Catch ex As Exception
                '2013/07/19 added,throw the exception to outer layer
                Throw New Exception(ex.ToString())
                'Ignore
            ...
            Try
                '获取Sexy Lingerie的产品
                Dim sexyUrl As String = "http://www.dresslily.com/sexy-lingerie-b-97.html?odr=new"
                GetProductAndProductIssue(sexyUrl, 8, "Sexy Lingerie", siteId, issueId, nowTime)
            Catch ex As Exception
                '2013/07/19 added,throw the exception to outer layer
                Throw New Exception(ex.ToString())
                'Ignore
    ...
    Public Sub GetCategory(ByVal siteId As Integer, ByVal issueId As Integer, ByVal nowTime As DateTime)
        Try
            ...
            cate1.ParentID = -1
            cate1.Category1 = "Men's Bags"
            cate1.SiteID = siteId
            cate1.LastUpdate = nowTime
            cate1.Description = "Men's Bags"
            cate1.Url = "http://www.dresslily.com/men-s-bags-c-127.html"
            cate1.Gender = "M"
            ...
            cate2.ParentID = -1
            cate2.Category1 = "Men's Watches"
            cate2.SiteID = siteId
            cate2.LastUpdate = nowTime
            cate2.Description = "Men's Watches"
            cate2.Url = "http://www.dresslily.com/men-s-watches-c-125.html"
            cate2.Gender = "M"
            ...
            cate3.ParentID = -1
            cate3.Category1 = "Men's Clothing"
            cate3.SiteID = siteId
            cate3.LastUpdate = nowTime
            cate3.Description = "Men's Clothing"
            cate3.Url = "http://www.dresslily.com/men-s-clothing-b-2.html"
            cate3.Gender = "M"
            ...
            cate4.ParentID = -1
            cate4.Category1 = "Men's Shoes"
            cate4.SiteID = siteId
            cate4.LastUpdate = nowTime
            cate4.Description = "Men's Shoes"
            cate4.Url = "http://www.dresslily.com/men-s-shoes-c-82.html"
            cate4.Gender = "M"
            ...
            cate5.ParentID = -1
            cate5.Category1 = "Sexy Lingerie"
            cate5.SiteID = siteId
            cate5.LastUpdate = nowTime
            cate5.Description = "Sexy Lingerie"
            cate5.Url = "http://www.dresslily.com/sexy-lingerie-b-97.html"
            cate5.Gender = "W"
            ...
            cate6.ParentID = -1
            cate6.Category1 = "Women's Clothing"
            cate6.SiteID = siteId
            cate6.LastUpdate = nowTime
            cate6.Description = "Women's Clothing"
            cate6.Url = "http://www.dresslily.com/women-s-clothing-b-1.html"
            cate6.Gender = "W"
    ...
    Public Sub GetProductAndProductIssue(ByVal pageUrl As String, ByVal maxCount As Integer, _
        ...
        Try
            ...
            For counter As Integer = 0 To maxCount - 1
               Dim liNodes As HtmlNodeCollection = productDivs(counter).SelectNodes("ul/li")
                ...
                ElseIf (liNodes.Count >= 5) Then
                    ...
                    End If
                End If
                ''Add freeShipping picture and ships24 picture,end
            ...
            '2013/4/8修改
            'If (categoryName = "Men's Clothing") Then
    ...
    Public Sub AddIssueSubject(ByVal issueId As Integer)
        ...
        subject = "Hi [FIRSTNAME],Special For Men ★" & mySubject & "Weekly Deals"
        helper.InsertIssueSubject(subject, issueId)
    End Sub

    ''' <summary>
    ''' 获取Weekly Deals的产品信息并添加到Products中（Men's Clothing，SectionID="DA"）
    ''' </summary>
    ''' <param name="siteId"></param>
    ''' <param name="issueId"></param>
    ''' <remarks></remarks>
    Public Sub GetWeeklyDeals(ByVal siteId As Integer, ByVal issueId As Integer, ByVal nowTime As DateTime)
        ...
        Dim listProductId As New List(Of Integer)
        Dim helper As New EFHelper()
        Dim weeklyUrl As String = "http://www.dresslily.com/men-s-clothing-b-2.html"
        ...
        Next
        If Not (insertProducts.Count = 0) Then
            listProductId.AddRange(helper.InsertListProduct(insertProducts, "Men's Clothing", siteId))
        End If
        If Not (updateProducts.Count = 0) Then
            listProductId.AddRange(helper.UpdateListProduct(updateProducts, "Men's Clothing", siteId))
        End If
        helper.InsertPOProductIssue(listProductId, siteId, issueId, "DA", "Hi [FIRSTNAME],Special For Men ★ ")
    End Sub
    ...
    Public Sub CreateContacts(ByVal siteId As Integer, ByVal planType As String, ByVal spreaLogin As String, _
        ...
        listCategoryMen = (From c In efContext.Categories
                        Where c.SiteID = siteId AndAlso c.Gender = "M"
                        Select c).ToList()
        For Each li In listCategoryMen
            ...
            End If
            'DresslilyMen
            Dim saveAsList As String = "ActiveMen" & Now.ToString("yyyyMMdd") & cateName
        ...
        contactList1.ContactList = "Men"
        contactList1.SendingStatus = "draft" '2013/12/31 added，Dresslily Men创建草稿状态
